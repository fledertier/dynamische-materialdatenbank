...
abstract class Countries {
  static final values = [
    ...
    Country(name: 'Bahamas (the)', code: 'BS'),
    ...
    Country(name: 'British Indian Ocean Territory (the)', code: 'IO'),
    ...
    Country(name: 'Dominican Republic (the)', code: 'DO'),
    ...
    Country(name: 'Falkland Islands (the) [Malvinas]', code: 'FK'),
    Country(name: 'Faroe Islands (the)', code: 'FO'),
    ...
    Country(name: 'French Southern Territories (the)', code: 'TF'),
    Country(name: 'Gabon', code: 'GA'),
    Country(name: 'Gambia (the)', code: 'GM'),
    ...
    Country(name: 'Holy See (the)', code: 'VA'),
    ...
    Country(name: 'Lao People\'s Democratic Republic (the)', code: 'LA'),
    ...
    Country(name: 'Marshall Islands (the)', code: 'MH'),
    ...
    Country(name: 'Philippines (the)', code: 'PH'),
    ...
    Country(name: 'Russian Federation (the)', code: 'RU'),
    ...
    Country(name: 'Sudan (the)', code: 'SD'),
    ...
    Country(name: 'Turks and Caicos Islands (the)', code: 'TC'),
    Country(name: 'Tuvalu', code: 'TV'),
    Country(name: 'Uganda', code: 'UG'),
    Country(name: 'Ukraine', code: 'UA'),
    Country(name: 'United Arab Emirates (the)', code: 'AE'),
    Country(
      name: 'United Kingdom of Great Britain and Northern Ireland (the)',
      code: 'GB',
    ),
    Country(name: 'United States Minor Outlying Islands (the)', code: 'UM'),
    Country(name: 'United States of America (the)', code: 'US'),
