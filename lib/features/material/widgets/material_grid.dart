...
import 'package:dynamische_materialdatenbank/features/color/providers/color_provider.dart';
...
import 'package:dynamische_materialdatenbank/features/query/providers/query_provider.dart';
import 'package:dynamische_materialdatenbank/shared/utils/miscellaneous_utils.dart';
import 'package:dynamische_materialdatenbank/shared/widgets/directional_menu_anchor.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer(
      builder: (context, ref, child) {
        final items = ref.watch(queriedMaterialsProvider).valueOrNull ?? [];
