...
import 'package:dynamische_materialdatenbank/features/material/attribute/custom/light/ray_visualization.dart';
        ...
        ref.watch(
              valueProvider(
                AttributeArgument(
                  ...
                  attributePath: AttributePath(Attributes.lightReflection),
                ),
              ),
            )
            as UnitNumber? ??
