...
import 'package:dynamische_materialdatenbank/shared/widgets/tags_field/selectable_tag.dart';
import 'package:dynamische_materialdatenbank/shared/widgets/tags_field/tags_field.dart';
    ...
    return TagsField<Country>(
      ...
      onChanged: (countries) {
        ref.read(materialProvider(materialId).notifier).updateMaterial({
          Attributes.originCountry: countries
